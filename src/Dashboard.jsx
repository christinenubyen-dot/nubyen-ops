...
export default function Dashboard() {
  ...
  return (
    <div className="wrap">
      ...
      <nav className="tabs">
        {[["summary", "Summary"], ["orders", "Orders & Delivery"], ["stock", "Stock & Replenishment"], ["aging", "Aging Reports"]].map(([k, l]) => (
